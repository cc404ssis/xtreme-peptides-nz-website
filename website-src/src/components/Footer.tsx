    ...
    <footer className="relative" style={{ background: "var(--xp-black)", borderTop: "1px solid var(--xp-red)", zIndex: 3 }}>
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 py-12 sm:py-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          {/* Quick Links */}
          <div className="text-center md:text-left">
            <h4 className="font-heading text-sm tracking-[0.15em] uppercase mb-5" style={{ color: "var(--xp-white)" }}>
              Quick Links
            </h4>
            <ul className="space-y-3">
              {[
                ...
                <li key={link.to}>
                  <Link
                    to={link.to}
                    className="font-heading text-sm tracking-[0.06em] transition-colors"
          ...
          <div className="text-center md:text-left">
            ...
            <ul className="space-y-3">
              ...
              <li className="font-heading text-sm" style={{ color: "var(--xp-grey-text)" }}>New Zealand</li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8" style={{ borderTop: "1px solid var(--xp-border)" }}>
          <p className="font-mono text-[10px] tracking-[0.2em] uppercase text-center mb-3" style={{ color: "rgba(255,255,255,0.18)" }}>
          ...
          <div className="flex items-center justify-center gap-4 font-mono text-[10px] tracking-[0.15em] uppercase" style={{ color: "rgba(255,255,255,0.18)" }}>
          ...
          <p className="font-mono text-[10px] tracking-[0.15em] uppercase text-center mt-4" style={{ color: "rgba(255,255,255,0.12)" }}>
